...
public class BoundaryPrendreEtal {
	...
	public void prendreEtal(String nomVendeur) {
		...
		if (!nomVendeurConnu) {
			...
			System.out.println("Bonjour "+nomVendeur+", je vias regarder si je peux vous trouver un étal.");
	...
	private void installerVendeur(String nomVendeur) {
		...
		if (numeroEtal!=-1) {
			System.out.println("Le vendeur "+nomVendeur+" s'est installe à l'étal n°"+numeroEtal);
		}
	}
}
